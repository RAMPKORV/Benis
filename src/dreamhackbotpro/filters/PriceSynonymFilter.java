...
class PriceSynonymFilter implements MessageFilter {
    ...
    Pattern pattern = Pattern.compile("([1-9][0-9]*)[ ]*(lax|spänn|kr|hundring|hundralapp|hundralappar|kronor|riksdaler|sek|\\:-|tjuga|tjugor|tjugolapp|tjugolappar)", Pattern.CASE_INSENSITIVE);
    @Override
